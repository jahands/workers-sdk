import { consolidateRoutes } from "./routeConsolidation";

describe("route-consolidation", () => {
	describe("multiple routes", () => {
		it("should consolidate redundent routes", () => {
		...
		it("should consolidate thousands of redundent routes", () => {
		...
		it("should consolidate many redundent sub-routes", () => {
			const routes: string[] = [];
			const limit = 15;
