/**
 * consolidateRoutes consolidates redundent routes - eg. ["/api/*"", "/api/foo"] -> ["/api/*""]
 ...
 * @returns Non-redundent list of routes
 */
export function consolidateRoutes(routes: string[]): string[] {
	...
	// Find routes that might render other routes redundent
